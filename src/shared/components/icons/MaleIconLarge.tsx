...
interface MaleIconLargeProps {
  width?: number;
  height?: number;
  color?: string;
}

const MaleIconLarge: React.FC<MaleIconLargeProps> = ({ 
  width = 64, 
  height = 67, 
  color = '#FFFFFF' 
}) => {
  return (
    <Svg width={width} height={height} viewBox="0 0 72 75" fill="none">
      <Path
